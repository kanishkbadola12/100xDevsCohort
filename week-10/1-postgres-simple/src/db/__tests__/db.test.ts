...
describe('Todo Operations', () => {
    ...
    test('createTodo inserts a new todo for a user', async () => {
      ...
      const todo = await createTodo(userId, title, description) as any;
    ...
    test('updateTodo marks a todo as done', async () => {
      ...
      const { id: todoId } = await createTodo(userId, 'Update Test', 'To be updated') as any;
  
      const updatedTodo = await updateTodo(todoId) as any;
